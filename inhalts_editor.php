...
function has_help_file() {
	...
	$help_file = $ne2_config_info['help_path'] .'inhalts_editor'. $ne2_config_info['help_filesuffix'] ;
...
<title>Inhaltsinfo bearbeiten - <?php echo($ne2_config_info['app_titleplain']); ?></title>
...
function loadContent() {
	if(tinymceReady) {
		$.get("app/edit_inhalts.php?r=" + Math.random(), {
...
<div id="wrapper">
	...
	?>
		<form action="" method="post" name="frmEdit" id="frmEdit">
			<fieldset>
				<legend>Inhaltsinfo bearbeiten</legend>
